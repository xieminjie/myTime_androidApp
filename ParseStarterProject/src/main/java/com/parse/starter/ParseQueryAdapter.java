...
public class ParseQueryAdapter<T extends ParseObject> extends BaseAdapter {
    ...
    private WeakHashMap<com.parse.ParseImageView, Void> imageViewSet = new WeakHashMap<>();
    ...
    private void loadObjects(final int page, final boolean shouldClear) {
        ...
        query.findInBackground(new FindCallback<T>() {
            ...
            public void done(List<T> foundObjects, ParseException e) {
                ...
                if ((!Parse.isLocalDatastoreEnabled() && query.getCachePolicy() == CachePolicy.CACHE_ONLY)
    ...
    public View getItemView(T object, View v, ViewGroup parent) {
        ...
        if (this.imageKey != null) {
            ...
            try {
                imageView = (com.parse.ParseImageView) v.findViewById(android.R.id.icon);
            } catch (ClassCastException ex) {
                throw new IllegalStateException(
    ...
    public void setPlaceholder(Drawable placeholder) {
        ...
        Iterator<com.parse.ParseImageView> iter = this.imageViewSet.keySet().iterator();
        com.parse.ParseImageView imageView;
        while (iter.hasNext()) {
            imageView = iter.next();
            if (imageView != null) {
    ...
    private View getDefaultView(Context context) {
        ...
        com.parse.ParseImageView imageView = new com.parse.ParseImageView(context);
